// A menu driven and interactive program to show how a stack is implemented.
// It will ask the user every time, what operation to perform on the stack.
// We have defined the maximum size of stack as 10.
